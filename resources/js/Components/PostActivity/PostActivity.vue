...
<template>
    <div class="flex flex-col h-full relative">
        <div class="flex flex-col h-full overflow-y-scroll mixpost-scroll-style row-px row-pt pr-1 sm:!pr-4 lg:!pr-6 pb-md blur-sm">
            <ul class="space-y-md">
                <li>
                    <TypeLayout>
                        <template #default>
                ...
                <li>
                    <ItemCommentType name="Frank" created_at="Dec 1, 15:25">
                        <span class="text-indigo-500">@Aaron</span>, could you please enhance the engagement level of this post? Thank you!
                    </ItemCommentType>
                </li>
                <li>
                    <TypeLayout>
