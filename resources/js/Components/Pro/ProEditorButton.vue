...
<template>
  <div class="relative group z-10">
    ...
    <div
      :class="{
        'opacity-0 group-hover:opacity-100 transition-opacity ease-in-out duration-200':
          showLabelHover
      }"
      class="absolute top-0 right-0 -mt-xs -mr-xs"
    >
      <ProLabel :with-title="false" padding-class="py-[1px] px-[1px]" />
    </div>
  </div>
</template>
