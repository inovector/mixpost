...
<template>
  <div class="row-px mt-2xl">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-sm">
      <Panel>
        <template #title
          ><span v-tooltip="'The number of times where your posts were liked'">Likes</span>
        </template>
      ...
      <Panel>
        <template #title
          ><span v-tooltip="'The number of times your tweets have been retweeted'">Retweets</span>
        </template>
      ...
      <Panel>
        <template #title
          ><span v-tooltip="'The number of times people saw your posts'">Impressions</span>
        </template>
