...
<template>
  <div class="row-px mt-2xl">
    <div class="grid grid-cols-3 gap-sm">
      <Panel>
        <template #title
          ><span v-tooltip="'The number of replies to your posts'">Replies</span>
        </template>
      ...
      <Panel>
        <template #title
          ><span v-tooltip="'The number of times your posts have been reblogs'">Reblogs</span>
        </template>
      ...
      <Panel>
        <template #title
          ><span v-tooltip="'The number of times your posts have been added to favorites'"
            >Favourites</span
          >
        </template>
