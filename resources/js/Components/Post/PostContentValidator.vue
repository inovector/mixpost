...
const { currentCharMaxLimit, currentCharLeft, getCharMaxLimit, getTextLength, calculateCharLeft } =
  usePostCharacterLimit(props)

const handleCharMaxLimitError = ({ charLimit, charLeft, accountId, accountName, providerName }) => {
  if (charLeft < 0) {
...
watch(
  [currentCharLeft, currentCharMaxLimit, currentMediaMaxLimits, currentMediaUsed],
  debounce(() => {
