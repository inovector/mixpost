...
const duplicate = () => {
  router.post(
    route('mixpost.posts.duplicate', { post: props.itemId }),
    {},
    {
      onSuccess() {
...
<template>
  <div>
    <div class="flex flex-row items-center gap-xs">
      <PureButtonLink v-tooltip="'Edit'" :href="route('mixpost.posts.edit', { post: itemId })">
        <PencilSquareIcon />
      </PureButtonLink>
    ...
    >
      ...
      <template #footer>
        <SecondaryButton class="mr-xs" @click="confirmationDeletion = false"
