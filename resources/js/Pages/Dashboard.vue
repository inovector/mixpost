  ...
  <div class="row-py">
    <PageHeader title="Dashboard">
      <Tabs v-if="accounts.length">
        <Tab :active="isPeriodSelected('7_days')" @click="selectPeriod('7_days')">7 days</Tab>
        <Tab :active="isPeriodSelected('30_days')" @click="selectPeriod('30_days')">30 days</Tab>
        <Tab :active="isPeriodSelected('90_days')" @click="selectPeriod('90_days')">90 days</Tab>
      </Tabs>
    </PageHeader>
