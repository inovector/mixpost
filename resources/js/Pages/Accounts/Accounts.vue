...
const updateAccount = accountId => {
  router.put(
    route('mixpost.accounts.update', { account: accountId }),
    {},
    {
      preserveScroll: true,
      onSuccess(response) {
...
<template>
  ...
  <div class="w-full mx-auto row-py">
    <PageHeader :title="title">
      <template #description> Connect a social account you'd like to manage. </template>
    </PageHeader>
          ...
          <Panel class="relative">
            ...
            <div class="flex flex-col justify-center">
              ...
              <div v-if="!account.authorized" class="absolute top-0 left-0">
                <div v-tooltip="'Unauthorized'" class="w-md h-md bg-red-500 rounded-full"></div>
              </div>
  ...
  >
    ...
    <template #body> Are you sure you want to delete this account? </template>
    <template #footer>
      <SecondaryButton
