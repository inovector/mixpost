    ...
    <div class="mt-lg row-px w-full">
        ...
        <Table>
          <template #body>
            <TableRow :hoverable="true">
              <TableCell>
                <Badge :variant="health.env === 'production' ? 'success' : 'warning'"
                  >Environment</Badge
                >
              </TableCell>
              <TableCell>
            ...
            <TableRow :hoverable="true">
              <TableCell>
                <Badge
                  :variant="
                    health.horizon_status === 'Active'
                      ? 'success'
                      : health.horizon_status === 'Paused'
                        ? 'warning'
                        : 'error'
                  "
                >
              ...
              <TableCell>
                <span v-if="health.horizon_status === 'Inactive'">
                  ...
                  Read the
                  <a
                    :href="`${$page.props.mixpost.docs_link}/lite/installation/laravel-package#5-install-horizon`"
                    >documentation</a
                  >.
                </span>
                <span v-else>
            ...
            <TableRow :hoverable="true">
              ...
              <TableCell>
                <span v-if="health.has_queue_connection"
                  >Queue connection settings for mixpost-redis exist.</span
                >
                <span v-else>
                  <span class="block"
                    >No valid <span class="font-medium">queue connection</span> found.</span
                  >
                  <span class="block"
                    >Configure a queue connection with the
                    <span class="font-medium">mixpost-redis</span> key.</span
                  >
                  Read the
                  <a
                    :href="`${$page.props.mixpost.docs_link}/lite/installation/laravel-package#5-install-horizon`"
      ...
      <Panel class="mt-lg">
        ...
        <Table>
          <template #body>
            <TableRow :hoverable="true">
              <TableCell class="font-medium"> App directory </TableCell>
              <TableCell>
                {{ tech.base_path }}
              </TableCell>
            </TableRow>
            <TableRow :hoverable="true">
              <TableCell class="font-medium"> Upload Media Disk </TableCell>
              <TableCell>
                {{ tech.disk }}
              </TableCell>
            </TableRow>
            <TableRow :hoverable="true">
              <TableCell class="font-medium"> Log Channel </TableCell>
              <TableCell>
                {{ tech.log_channel }}
              </TableCell>
            </TableRow>
            ...
            <TableRow :hoverable="true">
              <TableCell class="font-medium"> User agent </TableCell>
              <TableCell>
                {{ tech.user_agent }}
              </TableCell>
            </TableRow>
            ...
            <TableRow :hoverable="true">
              <TableCell class="font-medium"> Mixpost Lite </TableCell>
              <TableCell>
